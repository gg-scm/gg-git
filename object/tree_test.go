		...
		parsed: Tree{
			{
				Name: "settings.json",
				Mode: 0100644,
				Hash: hashLiteral("19571d8eb68230d997eb0254bdc50ab0c1085598"),
			},
		},
	},
	{
		...
		parsed: Tree{
			{
				Name: ".gitignore",
				Mode: 0100644,
				Hash: hashLiteral("5f1b3cd904bfb0f7e28917897d2dcb659a1980dd"),
			},
			{
				Name: "go.mod",
				Mode: 0100644,
				Hash: hashLiteral("3d6156efac8ac8e403bd3ab5edb7884c8d48faae"),
			},
			{
				Name: "go.sum",
				Mode: 0100644,
				Hash: hashLiteral("e21464d5acf0fd836652889ab37a9afdbcbeb2ba"),
			},
			{
				Name: "init.go",
				Mode: 0100644,
				Hash: hashLiteral("158a819902699f8359045450b48db869b3fd305d"),
			},
			{
				Name: "main.go",
				Mode: 0100644,
				Hash: hashLiteral("0b8a78624bbba5e8f79f7bd459b51d2a4b03107d"),
			},
			{
				Name: "schema.go",
				Mode: 0100644,
				Hash: hashLiteral("cc829be7395b4660f3dd360aea843b5423ba3ff4"),
			},
		},
	},
	{
		...
		parsed: Tree{
			...
			},
			{
				Name: ".vscode",
				Mode: 040000,
				Hash: hashLiteral("a47995a165e75bf2a04b3d4165ff850449dbc542"),
			},
			{
				Name: "go.mod",
				Mode: 0100644,
			...
			},
			{
				Name: "init.go",
				Mode: 0100644,
				Hash: hashLiteral("7ebb0d9d9434c08a5c357c3a7b1a8d0a47f17e66"),
			},
			{
				Name: "main.go",
				Mode: 0100644,
				Hash: hashLiteral("efca101c3f7333df06b532e171f89501fb37c0b3"),
			},
			{
				Name: "root.go",
				Mode: 0100644,
				Hash: hashLiteral("0e467721ee68dd86b98cd2f613c15a2fb953a275"),
			},
			{
				Name: "schema.go",
				Mode: 0100644,
